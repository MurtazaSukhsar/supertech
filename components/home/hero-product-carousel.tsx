...
const ITEMS: Item[] = [
  ...
  { file: 'pvc-flexible-duct.png', productId: 'pvc-flexible-duct' },
  { file: 'industrial-socket.png', productId: 'industrial-socket' },
  { file: 'copper-fitting.png', productId: 'copper-fitting' },
  { file: 'rubber-lined-clamp.png', productId: 'rubber-lined-clamp' },
  { file: 'weldfix-upvc-cement.png', productId: 'weldfix-upvc-cement' },
  { file: 'access-valves.png', productId: 'access-valves' },
  { file: 'aluminium-rivet.png', productId: 'aluminium-rivet' },
  { file: 'upvc-fitting.png', categorySlug: 'plumbing', label: 'Plumbing Supplies' },
  { file: 'galvanized-fasteners.png', categorySlug: 'hardware', label: 'Hardware Supplies' },
]
